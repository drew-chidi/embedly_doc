---
title: 'Customer KYC Upgrade - Address Verification (V2)'
api: 'POST https://waas-staging.embedly.ng/api/v2/customers/kyc/address-verification'
...
<ParamField body='image' type='string' required>
  Use https://waas-staging.embedly.ng/api/v1/utilities/upload to generate a url
