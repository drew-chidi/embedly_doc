...
<ParamField path="customerId" type="string" required></ParamField>
...
<ParamField body="bvnVerified" type="boolean"></ParamField>

<ParamField body="ninVerified" type="boolean"></ParamField>
