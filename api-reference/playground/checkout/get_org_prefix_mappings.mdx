...
description: 'Retrieves all paginated organisation prefix mappings for the specified organisation. Supports search by secondary prefix, alias, organisation name, or primary prefix code. Admin access required.'
---
