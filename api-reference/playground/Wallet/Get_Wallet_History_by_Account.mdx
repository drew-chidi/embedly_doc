---
title: 'Get Wallet History by Account Number'
api: 'GET /wallets/account-number/history'
description: 'The endpoint displays the transaction history for a specific wallet using the account number over a specified time range.'
---
